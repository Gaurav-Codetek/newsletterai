...
def send_bulk_mailer(receiver_email, subject, club, college):
    try:
        ...
        <b><p>Date: September 26-27, 2025</p></b>
        ...
        <b><h3>Registration process</h3></b>
        <p>The registration process is straightforward and, most importantly, completely free of cost. We firmly believe that financial constraints should never prevent talented individuals from participating in meaningful technical challenges.</p>
        
        <b>Registration link : <a href='https://www.terafac.com/hackathon-details'>Click here</a></b>
        
        <p>Contact Information</p>
        <p>Should you have any questions about the event, registration process, or specific technical details, please do not hesitate to reach out to our organizing team:</p>
        <p>Harsh Bhati: +91 92590 61679</p>
        <p>Vinay kumar: +91 81270 37412</p>
        
        <p>We are genuinely enthusiastic about the possibility of your club joining this event. Your participation would not only enhance the competitive spirit of the hackathon but also contribute to the overall quality of innovations we expect to see.</p>
        <p>We look forward to witnessing the creative solutions your talented team members will develop at Brains & Bots 2025.</p>
        
        <p>Best regards,</p>
        <p>Harsh Bhati & Vinay Kumar</p>
        <p>Organizing Committee</p>
        <p>Brains & Bots 2025</p>
        <p>TERAFAC & SAE UIET PU</p>
        <br>
        <p>Building the future of Robotics & Physicial AI together</p>
        """
